...
export class Producto extends Entity {
  ...
  @property({
    ...
    required: true,
    precision: 53,
    mssql: {columnName: 'CostoCompra', dataType: 'float', dataLength: null, dataPrecision: 53, dataScale: null, nullable: 'NO'},
  })
  costoCompra: number;
  ...
  @property({
    ...
    required: true,
    precision: 53,
    mssql: {columnName: 'PrecioVenta', dataType: 'float', dataLength: null, dataPrecision: 53, dataScale: null, nullable: 'NO'},
  })
  precioVenta: number;
